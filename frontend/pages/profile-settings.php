  ...
  <div class="settings-container">
    ...
    <div class="profile-content">
      ...
      <div class="information-container">
        <form class="" name="biography" action="backend/account/update-biography.php" method="post">
      <fieldset>
        <input type="text" name="fullname" id="fullname" placeholder="Fullname" value="<?php if (!empty($biography_info[0]['fullname'])): ?><?php echo $biography_info[0]['fullname'];?><?php else: echo "Fullname";?>
      <?php endif; ?>">
      </fieldset>
      <fieldset>
        <input type="text" name="dateofbirth" placeholder="yyyy/mm/dd" value="<?php if (!empty($biography_info[0]['dateofbirth'])): ?><?php echo $biography_info[0]['dateofbirth'];?><?php else: echo "yyyy/mm/dd";?>
      <?php endif; ?>"/>
      </fieldset>
      <fieldset>
        <select name="gender">
          <option value="<?php if (!empty($biography_info[0]['gender'])): ?>
          <?php echo $biography_info[0]['gender']; ?>
        <?php else: echo "Gender"; ?>
          <?php endif; ?>"><?php if (!empty($biography_info[0]['gender'])): ?>
          <?php echo $biography_info[0]['gender']; ?>
        <?php else: echo "Gender"; ?>
          <?php endif; ?></option>
      ...
      <fieldset>
      <select name="country">
      <option value="<?php if (!empty($biography_info[0]['country'])): ?>
      <?php echo $biography_info[0]['country']; ?>
    <?php else: echo "Country..."; ?>
      <?php endif; ?>" selected><?php if (!empty($biography_info[0]['country'])): ?>
      <?php echo $biography_info[0]['country']; ?>
    <?php else: echo "Country..."; ?>
      <?php endif; ?></option>
